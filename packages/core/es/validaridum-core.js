...
var pickByNotNil = pickBy(notNil);
/**
...
var existFormatMessage = o(isFunction, path(['intl', 'formatMessage']));
/**
 * For merging validation results.
 * We don't want to null results replacing those already filled.
 */

var mergeResults = mergeDeepAllWith(
	cond([
