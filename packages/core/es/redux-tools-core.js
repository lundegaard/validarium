...
const isIntlMessage = function isIntlMessage(x) {
	return x && notNil(x.id) && notNil(x.defaultMessage);
};
...
const validate = ifElse(isArray, validateListDescriptor, validateObjectDescriptor);
...
const validateMany = useWith(map, [validate, defaultToEmptyArray]);
...
export { createMainValidate, validate, validateMany, createValidation, createOptionalValidation };
