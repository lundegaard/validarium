(function(global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		? factory(exports, require('ramda-extension'))
		: typeof define === 'function' && define.amd
			? define(['exports', 'ramda-extension'], factory)
			: factory((global.ValidariumIntl = {}), global.R_);
})(this, function(exports, ramdaExtension) {
	'use strict';
	...
	var hasLengthInInterval = function(min, max) {
		return createValidation(o(ramdaExtension.between(min, max), length), m.hasLengthInInterval, {
			max: max,
			min: min,
		});
	};
	...
	var hasValueInInterval = function(min, max) {
		return createValidation(ramdaExtension.between(min, max), m.hasValueInInterval, {
			max: max,
		});
	};
	...
	var isNumber = createValidation(ramdaExtension.isNumeric, m.isNumber);
	...
	anyPass([isNil, allPass([ramdaExtension.isArray, allIsNil])]);
	...
	var isEmail = function(email) {
		...
		return ramdaExtension.isNilOrEmptyString(email) || (re.test(email) && email.length <= 200);
	};
	...
	var isPhoneNumber = anyPass([ramdaExtension.isNilOrEmptyString, testPhoneNumber]);
	...
	exports.hasLengthInInterval = hasLengthInInterval;
	exports.hasOnlyDigits = hasOnlyDigits;
	exports.hasValueMin = hasValueMin;
	exports.isInteger = isInteger;
	exports.isPositiveNumber = isPositiveNumber;
	exports.hasLengthMax = hasLengthMax;
	exports.hasValueInInterval = hasValueInInterval;
	exports.isDivisibleBy = isDivisibleBy;
	exports.isNumber = isNumber;
	exports.isRequired = isRequired;
	exports.hasLengthMin = hasLengthMin;
	exports.hasValueMax = hasValueMax;
	exports.isEmail = isEmail$1;
	exports.isPhoneNumber = isPhoneNumber$1;
	exports.hasNoSpecialSymbols = hasNoSpecialSymbols;
