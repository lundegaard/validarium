(function(global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		...
		: typeof define === 'function' && define.amd
			...
			: factory(
					(global.ReduxToolsIntl = {}),
					global.reactIntl,
					global.R_,
					global.createValidation,
					global.lndCardifUtils
			  );
})(this, function(exports, reactIntl, ramdaExtension, createValidation, lndCardifUtils) {
	'use strict';

	createValidation =
		createValidation && createValidation.hasOwnProperty('default')
			? createValidation.default
			: createValidation;

	const m = reactIntl.defineMessages({
		isDivisibleBy: {
	...
	const isNumber = createValidation(ramdaExtension.isNumeric, m.isNumber);
	...
	const isEmail = createValidation(lndCardifUtils.isEmail, m.isEmail);

	const isPhoneNumber = createValidation(lndCardifUtils.isPhoneNumber, m.isPhoneNumber);
	...
	const expandTextCharToNumber = o(
		ramdaExtension.listToString,
		map(when(ramdaExtension.isNotNumeric, decodeChar))
